...
import { getClientPedidoEstadoLabel } from "../../shared/types"
import type { ClientPedidoDetalle } from "../../shared/types"

interface ClientPedidoInfoCardProps {
  pedido: ClientPedidoDetalle
}
...
export function ClientPedidoInfoCard({ pedido }: ClientPedidoInfoCardProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent className="space-y-6">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              value={getClientPedidoEstadoLabel(pedido.estado)}
              readOnly
              className="cursor-default focus-visible:ring-0"
            />
          </div>
